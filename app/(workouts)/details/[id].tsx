          ...
          >
            ...
            {exercise.notes ? (
              <View className="flex-row items-start mb-3">
                ...
                <Text className="ml-2 text-gray-600 dark:text-gray-300 flex-1">
                  {exercise.notes}
                </Text>
              </View>
            ) : null}
            ...
            {/* Sets */}
            <View className="mt-2">
              <View className="flex-row bg-gray-200 dark:bg-gray-700 rounded-t-lg p-3">
                <Text className="font-medium text-gray-700 dark:text-gray-200 flex-1">
                  Set
                </Text>
                <Text className="font-medium text-gray-700 dark:text-gray-200 w-20 text-center">
                  Weight
                </Text>
                <Text className="font-medium text-gray-700 dark:text-gray-200 w-20 text-center">
                  Reps
                </Text>
                <Text className="font-medium text-gray-700 dark:text-gray-200 w-16 text-center">
                  RPE
                </Text>
              </View>
              ...
              {exercise.sets.map((set, setIndex) => (
                ...
                >
                  ...
                  <Text className="text-gray-800 dark:text-white w-20 text-center">
                    {set.weight}
                  </Text>
                  <Text className="text-gray-800 dark:text-white w-20 text-center">
                    {set.reps}
                  </Text>
                  <Text className="text-gray-800 dark:text-white w-16 text-center">
                    {set.rpe || "-"}
                  </Text>
                </View>
              ))}
